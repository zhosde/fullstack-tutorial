...
module.exports = {
  Query: {
    launches: async (_, { pageSize = 20, after }, { dataSources }) => {
      ...
      return {
        ...
        // if cursor at the end of the paginated results is the same as the
        // last item in all results, then there're no more results after this
  ...
  Mutation: {
    login: async (_, { email }, { dataSources }) => {
      ...
      if (user) {
        // token to represent user's active session
